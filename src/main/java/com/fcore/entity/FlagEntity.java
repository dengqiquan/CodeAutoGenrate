...
public class FlagEntity {
	...
	/**
	 * 是否创建mapper对应的dao java类
	 */
	private boolean isCreateMapperJava = false;
	...
	public boolean isCreateMapperJava() {
		return isCreateMapperJava;
	}
	public void setCreateMapperJava(boolean isCreateMapperJava) {
		this.isCreateMapperJava = isCreateMapperJava;
	}
