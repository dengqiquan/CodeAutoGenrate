...
import com.fcore.entity.MenuEntity;
        ...
        */
        public static String createAllMenu(String topMenus,DbEntity dbEntity,List<MenuEntity> menulist,String menuTable) throws Exception{
        	...
        	for(int i=0;i<menulist.size();i++){
				...
				int pid = (Integer) FirstMenuMap.get(firstname);
				String currentname = menu.getTableDesc();
				String entityname = CreateEntityUtil.initcap(menu.getTableName());
				...
				sb.append(map.get("sql"));
				current_end = (Integer) map.get("end_index");
				current_end ++;
        	}
        	return sb.toString();
        }
